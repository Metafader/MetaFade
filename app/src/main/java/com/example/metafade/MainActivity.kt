...
private fun showExif(exif: ExifInterface) : String {
    ...
    metadataString.append("Camera Lens Make  : ").append(exif.getAttribute(ExifInterface.TAG_LENS_MAKE)).append(" \n")
    metadataString.append("Camera Lens Specification  : ").append(exif.getAttribute(ExifInterface.TAG_LENS_SPECIFICATION)).append(" \n")
    metadataString.append("Camera Lens Model  : ").append(exif.getAttribute(ExifInterface.TAG_LENS_MODEL)).append(" \n")
    metadataString.append("Software  : ").append(exif.getAttribute(ExifInterface.TAG_SOFTWARE)).append(" \n")
    metadataString.append("Body Serial number  : ").append(exif.getAttribute(ExifInterface.TAG_BODY_SERIAL_NUMBER)).append(" \n")
